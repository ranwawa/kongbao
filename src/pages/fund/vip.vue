      ...
      <view class="vip-section vip-cash">
        ...
        <view
          ...
          :class="{
            ...
            'vip-cash__item_active': item.id === currentVip.id,
          }"
          :data-tag="item.tag"
          @click="currentTariff = item"
        >
          <view class="vip-cash__content">
            <view class="vip-cash__price">
              {{ item.price }}
            </view>
          ...
          <view class="vip-cash__btn" @click.stop="test(item)"> 立即开通 </view>
        </view>
      </view>
      <!-- 权益介绍 -->
...
.vip-cash {
  &__item {
    ...
    &_disable .vip-cash__content {
      background: linear-gradient(to right, #ffffff, #ffffff) top left /
          calc(100% - 13px) 3px no-repeat,
        linear-gradient(to bottom, #ffffff, #e7e7e7) top left / 3px 100%
          no-repeat,
  ...
  &__btn {
    ...
    background: radial-gradient(
      ...
      linear-gradient(to bottom, #f3635c, #e62665);
    color: #fff;
    font-size: $fz-xxl;
  }
  &__btn--disable {
    background: radial-gradient(
      ...
      radial-gradient(
        ...
        bottom left/ px2rpx(20) px2rpx(20) no-repeat,
      linear-gradient(to bottom, #ffffff, #c3c3c3);
  }
  &__price {
    font-size: px2rpx(32);
    font-weight: bold;
    background: linear-gradient(135deg, #fa9b95, #e72865);

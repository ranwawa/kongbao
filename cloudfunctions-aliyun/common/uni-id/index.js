  ...
  for (const o in e) {
    if (d(e, o) && r.test(o)) {
      ...
      (e[r] = e[o]),
        ...
        p(e[r])
          ? (e[r] = w(e[r], t))
          : Array.isArray(e[r]) && (e[r] = e[r].map((e) => w(e, t)));
    }
  }
  return e;
}
  ...
  if (p(t)) {
    for (const o in t) {
      ...
      l(i) && -1 === r.indexOf(o)
        ...
        : "string" == typeof i &&
          -1 === r.indexOf(o) &&
          ((e[o] = e[i]), n.shouldDelete.add(i));
    }
  } else {
    l(t) && (e = t(e));
  }
  if (n.shouldDelete) {
    for (const t of n.shouldDelete) {
      delete e[t];
    }
  }
...
function I() {
  const e = Object.assign(O, O[__ctx__.PLATFORM]) || {},
    t = Object.assign({ bindTokenToDevice: !0 }, e);
  return (
    [
      "passwordSecret",
      "tokenSecret",
      ...
      if (!t || !t[e]) {
        throw new Error(
          "请在公用模块uni-id的config.json或init方法中内添加配置项：" + e
        );
      }
    }),
    t
...
function N(e) {
  if (((this.buffer = null), (this.writable = !0), (this.readable = !0), !e)) {
    return (this.buffer = $.alloc(0)), this;
  }
  if ("function" == typeof e.pipe) {
    return (this.buffer = $.alloc(0)), e.pipe(this), this;
  }
...
var K = D.prototype.equal,
  q = M.prototype.equal;
function U(e) {
  return ((e / 8) | 0) + (e % 8 == 0 ? 0 : 1);
}
L.restore = function () {
  (D.prototype.equal = K), (M.prototype.equal = q);
};
var H = { ES256: U(256), ES384: U(384), ES512: U(521) };
var F = function (e) {
    var t = H[e];
    if (t) {
      return t;
...
var W = {
    derToJose: function (e, t) {
      ...
      if (o - i !== u) {
        throw new Error(
          '"s" specified length of "' + u + '", expected "' + (o - i) + '"'
        );
      }
      if (n < u) {
        throw new Error(
      ...
      for (var m = (i = r); i < m + p; ++i) {
        l[i] = 0;
      }
      return (
        e.copy(l, i, f + Math.max(-p, 0), f + u),
        (l = (l = l.toString("base64"))
          .replace(/=/g, "")
          .replace(/\+/g, "-")
          .replace(/\//g, "_"))
      );
    ...
    joseToDer: function (e, t) {
      ...
      return (
        (f[d++] = 48),
        u ? (f[d++] = c) : ((f[d++] = 129), (f[d++] = 255 & c)),
        (f[d++] = 2),
        (f[d++] = a),
        o < 0
          ? ((f[d++] = 0), (d += e.copy(f, d, 0, r)))
          : (d += e.copy(f, d, o, r)),
        (f[d++] = 2),
        (f[d++] = s),
        i < 0 ? ((f[d++] = 0), e.copy(f, d, r)) : e.copy(f, d, r + i),
        f
      );
    },
  },
...
function ee(e) {
  if (!Z.isBuffer(e) && "string" != typeof e) {
    ...
    if ("string" != typeof e.asymmetricKeyType) {
      throw oe(X);
    }
    if ("function" != typeof e.export) {
      throw oe(X);
    }
  }
}
function te(e) {
  if (!Z.isBuffer(e) && "string" != typeof e && "object" != typeof e) {
    throw oe("key must be a string, a buffer or an object");
  }
}
function re(e) {
...
function ie(e) {
  var t;
  return (
    (t = e), Z.isBuffer(t) || "string" == typeof t || (e = JSON.stringify(e)), e
  );
}
function ae(e) {
  return function (r, n) {
...
var ge = function (e) {
    var t = {
      ...
      r = { hs: se, rs: ue, ps: de, es: le, none: he },
...
function Re(e, t) {
  ...
  return (
    ...
    { header: r, payload: n, signature: Oe(e) }
  );
}
function Ae(e) {
  ...
  (this.readable = !0),
    ...
    (this.signature = new B(e.signature)),
    this.secret.once(
      "close",
      function () {
...
a.inherits(Ae, i),
  (Ae.prototype.verify = function () {
    try {
      var e = Ce(this.signature.buffer, this.algorithm, this.key.buffer),
        t = Re(this.signature.buffer, this.encoding);
      return (
        this.emit("done", e, t),
        this.emit("data", e),
        this.emit("end"),
...
(Le.prototype = Object.create(De.prototype)).constructor = Le;
var Ke = Le,
  qe = 1e3,
  Ue = 60 * qe,
  He = 60 * Ue,
    ...
    if ("number" === r && isFinite(e)) {
      return t.long
        ? (function (e) {
            var t = Math.abs(e);
            if (t >= Fe) {
              return Ge(e, t, Fe, "day");
            }
            if (t >= He) {
              return Ge(e, t, He, "hour");
            }
            if (t >= Ue) {
              return Ge(e, t, Ue, "minute");
            }
            if (t >= qe) {
              return Ge(e, t, qe, "second");
            }
            return e + " ms";
          })(e)
        : (function (e) {
            var t = Math.abs(e);
            if (t >= Fe) {
              return Math.round(e / Fe) + "d";
            }
            if (t >= He) {
              return Math.round(e / He) + "h";
            }
            if (t >= Ue) {
              return Math.round(e / Ue) + "m";
            }
            if (t >= qe) {
              return Math.round(e / qe) + "s";
            }
            return e + "ms";
          })(e);
    }
...
var ze = function (e, t) {
  ...
  We = A(function (e, t) {
    ...
    i[C] = "(?:~>?)";
    var R = a++;
    (i[R] = "(\\s*)" + i[C] + "\\s+"), (o[R] = new RegExp(i[R], "g"));
    var A = a++;
    i[A] = "^" + i[C] + i[x] + "$";
    var P = a++;
    i[P] = "^" + i[C] + i[j] + "$";
    ...
    i[U] = "(<|>)?=?\\s*\\*";
    for (var H = 0; H < 35; H++) {
      r(H, i[H]), o[H] || (o[H] = new RegExp(i[H]));
    }
    function F(e, t) {
      if (
        ((t && "object" == typeof t) ||
    ...
    (ne.prototype.parse = function (e) {
      ...
      (ne.prototype.intersects = function (e, t) {
        ...
        if (
          ...
          return (r = new ie(e.value, t)), ue(this.value, r, t);
        }
        if ("" === e.operator) {
          return (r = new ie(this.value, t)), ue(e.semver, r, t);
        }
        var n = !(
            (">=" !== this.operator && ">" !== this.operator) ||
      ...
      (ie.prototype.parseRange = function (e) {
        ...
        (e = e.replace(n, se)),
          r("hyphen replace", e),
          (e = e.replace(o[L], "$1$2$3")),
          r("comparator trim", e, o[L]),
          (e = (e = (e = e.replace(o[R], "$1~")).replace(o[N], "$1^"))
            .split(/\s+/)
            .join(" "));
        var i = t ? o[M] : o[V],
          a = e
      ...
      (ie.prototype.test = function (e) {
        ...
        for (var t = 0; t < this.set.length; t++) {
          if (ce(this.set[t], e, this.options)) {
            return !0;
          }
        }
        return !1;
...
Ze &&
  (Ye.splice(3, 0, "PS256", "PS384", "PS512"),
  Xe.splice(3, 0, "PS256", "PS384", "PS512"));
var et = /^\s+|\s+$/g,
  tt = /^[-+]0x[0-9a-f]+$/i,
  rt = /^0b[01]+$/i,
  nt = /^0o[0-7]+$/i,
  ...
  var r =
      ...
      (function (e) {
        return (
          ...
          dt.call(e, "callee") &&
          (!lt.call(e, "callee") || "[object Arguments]" == pt.call(e))
        );
      })(e)
        ? (function (e, t) {
    ...
    o = !!n;
  for (var i in e) {
    (!t && !dt.call(e, i)) || (o && ("length" == i || wt(i, n))) || r.push(i);
  }
  return r;
}
function yt(e) {
  if (
    ((r = (t = e) && t.constructor),
    (n = ("function" == typeof r && r.prototype) || ft),
    t !== n)
  ) {
    return mt(e);
  }
  ...
  for (var i in Object(e)) {
    dt.call(e, i) && "constructor" != i && o.push(i);
  }
  return o;
}
function wt(e, t) {
...
var Et = function (e, t, r, n) {
    ...
    return (
      ...
      (function (e) {
        return (
          "string" == typeof e ||
          (!vt(e) && St(e) && "[object String]" == pt.call(e))
        );
      })(e)
        ? r <= i && e.indexOf(t, r) > -1
        : !!i &&
...
var nr = {
    ...
    header: { isValid: Ut, message: '"header" must be an object' },
    encoding: { isValid: Jt, message: '"encoding" must be a string' },
    issuer: { isValid: Jt, message: '"issuer" must be a string' },
    subject: { isValid: Jt, message: '"subject" must be a string' },
    jwtid: { isValid: Jt, message: '"jwtid" must be a string' },
    noTimestamp: { isValid: xt, message: '"noTimestamp" must be a boolean' },
    keyid: { isValid: Jt, message: '"keyid" must be a string' },
    mutatePayload: {
      isValid: xt,
  ...
  or = {
    iat: { isValid: Nt, message: '"iat" should be a number of seconds' },
    exp: { isValid: Nt, message: '"exp" should be a number of seconds' },
    nbf: { isValid: Nt, message: '"nbf" should be a number of seconds' },
  };
function ir(e, t, r, n) {
  if (!Ut(r)) {
...
var ar = {
  ...
  cr = function (e, t, r, n) {
    ...
    if (
      ...
      return o(new De("clockTimestamp must be a number"));
    }
    if (
      void 0 !== r.nonce &&
      ("string" != typeof r.nonce || "" === r.nonce.trim())
    ) {
      return o(new De("nonce must be a non-empty string"));
    }
    var i = r.clockTimestamp || Math.floor(Date.now() / 1e3);
    if (!e) {
      return o(new De("jwt must be provided"));
    }
    if ("string" != typeof e) {
      return o(new De("jwt must be a string"));
    }
    var a,
      s = e.split(".");
    if (3 !== s.length) {
      return o(new De("jwt malformed"));
    }
    try {
      a = Ne(e, { complete: !0 });
    } catch (e) {
    ...
    return c(u, function (t, n) {
      if (t) {
        return o(
          new De("error in secret or public key callback: " + t.message)
        );
      }
      var c,
        f = "" !== s[2].trim();
      if (!f && n) {
        return o(new De("jwt signature is required"));
      }
      if (f && !n) {
        return o(new De("secret or public key must be provided"));
      }
      if (
        (f || r.algorithms || (r.algorithms = ["none"]),
        r.algorithms ||
          (r.algorithms =
            ~n.toString().indexOf("BEGIN CERTIFICATE") ||
            ~n.toString().indexOf("BEGIN PUBLIC KEY")
              ? Ye
              : ~n.toString().indexOf("BEGIN RSA PUBLIC KEY")
              ? Xe
              : Qe),
        !~r.algorithms.indexOf(a.header.alg))
      ) {
        return o(new De("invalid algorithm"));
      }
      try {
      ...
      if (!c) {
        return o(new De("invalid signature"));
      }
      var d = a.payload;
      if (void 0 !== d.nbf && !r.ignoreNotBefore) {
        if ("number" != typeof d.nbf) {
          return o(new De("invalid nbf value"));
        }
        if (d.nbf > i + (r.clockTolerance || 0)) {
          return o(new Ve("jwt not active", new Date(1e3 * d.nbf)));
        }
      }
      if (void 0 !== d.exp && !r.ignoreExpiration) {
        if ("number" != typeof d.exp) {
          return o(new De("invalid exp value"));
        }
        if (i >= d.exp + (r.clockTolerance || 0)) {
          return o(new Ke("jwt expired", new Date(1e3 * d.exp)));
        }
      }
      if (r.audience) {
        var p = Array.isArray(r.audience) ? r.audience : [r.audience];
        if (
          !(Array.isArray(d.aud) ? d.aud : [d.aud]).some(function (e) {
            return p.some(function (t) {
              return t instanceof RegExp ? t.test(e) : t === e;
            });
          })
        ) {
          return o(new De("jwt audience invalid. expected: " + p.join(" or ")));
        }
      }
      if (
        r.issuer &&
        (("string" == typeof r.issuer && d.iss !== r.issuer) ||
          (Array.isArray(r.issuer) && -1 === r.issuer.indexOf(d.iss)))
      ) {
        return o(new De("jwt issuer invalid. expected: " + r.issuer));
      }
      if (r.subject && d.sub !== r.subject) {
        return o(new De("jwt subject invalid. expected: " + r.subject));
      }
      if (r.jwtid && d.jti !== r.jwtid) {
        return o(new De("jwt jwtid invalid. expected: " + r.jwtid));
      }
      if (r.nonce && d.nonce !== r.nonce) {
        return o(new De("jwt nonce invalid. expected: " + r.nonce));
      }
      if (r.maxAge) {
        if ("number" != typeof d.iat) {
          return o(new De("iat required when maxAge is specified"));
        }
        ...
        if (i >= l + (r.clockTolerance || 0)) {
          return o(new Ke("maxAge exceeded", new Date(1e3 * l)));
        }
      }
      if (!0 === r.complete) {
        var m = a.signature;
        return o(null, { header: u, payload: d, signature: m });
      }
      return o(null, d);
    });
  },
  ur = function (e, t, r, n) {
    ...
    if (!t && "none" !== r.algorithm) {
      return a(new Error("secretOrPrivateKey must have a value"));
    }
    if (void 0 === e) {
      return a(new Error("payload is required"));
    }
    if (o) {
      try {
        !(function (e) {
      ...
      if (s.length > 0) {
        return a(
          new Error(
            "invalid " + s.join(",") + " option for " + typeof e + " payload"
          )
        );
      }
    }
    ...
    if (
      (r.noTimestamp ? delete e.iat : o && (e.iat = c), void 0 !== r.notBefore)
    ) {
      try {
    ...
    if ("function" != typeof n) {
      return $e.sign({ header: i, payload: e, secret: t, encoding: u });
    }
    (n = n && tr(n)),
      $e
        .createSign({ header: i, privateKey: t, payload: e, encoding: u })
        .once("error", n)
...
function fr() {
  const e = t.createHash("md5"),
    r = /MicroMessenger/i.test(__ctx__.CLIENTUA)
      ? __ctx__.CLIENTUA.split(" Process/appbrand")[0]
      : __ctx__.CLIENTUA;
...
const dr = {
  createToken: function (e) {
    ...
    return {
      token: ur(r, t.tokenSecret, { expiresIn: t.tokenExpiresIn }),
  ...
  checkToken: async function (e) {
    ...
    try {
      ...
      if (t.bindTokenToDevice && r.clientId !== fr()) {
        return {
          code: 30201,
          msg: "token不合法，请重新登录",
        };
      ...
      if (!n.data || 0 === n.data.length || !n.data[0].token) {
        return {
          code: 30202,
          msg: "token不合法，请重新登录",
        };
      ...
      const o = n.data[0];
      if (1 === o.status) {
        return { code: 10001, msg: "账号已禁用" };
      }
      let i = o.token;
      return (
        "string" == typeof i && (i = [i]),
        -1 === i.indexOf(e)
          ? { code: 30202, msg: "token不合法，请重新登录" }
...
async function lr({ inviteCode: e }) {
  let t,
    r = 10;
  e ? ((r = 1), (t = e)) : (t = pr());
  let n = !1;
  try {
    for (; r > 0 && !n; ) {
      r -= 1;
      if (0 === (await j.where({ invite_code: t }).count()).total) {
        n = !0;
        break;
      }
      t = pr();
...
async function mr(e) {
  ...
  const n = await lr({ inviteCode: r });
  return n.code > 0
    ? n
    : ((e.my_invite_code = n.inviteCode),
      (t = await j.add(e)),
      { code: 0, msg: "邀请码设置成功", result: t });
}
...
async function wr({ name: e, url: t, data: r, options: n, defaultOptions: o }) {
  let i = {};
  const a = b(Object.assign({}, r));
  a && a.access_token && delete a.access_token;
  try {
    (n = Object.assign({}, o, n, { data: a })),
  ...
  if (
    !Buffer.isBuffer(s) ||
    (0 !== u.indexOf("text/plain") && 0 !== u.indexOf("application/json"))
  ) {
    Buffer.isBuffer(s) &&
      (s = {
        buffer: s,
...
class br {
  constructor(e) {
    this.options = Object.assign(
      { baseUrl: "https://api.weixin.qq.com", timeout: 5e3 },
      e
    );
  }
...
const _r = { RSA: "RSA-SHA1", RSA2: "RSA-SHA256" };
var Sr = { code2Session: { returnValue: { openid: "userId" } } };
...
class Er extends class {
  constructor(e = {}) {
    ...
    const r =
      "PKCS8" === this.options.keyType ? "PRIVATE KEY" : "RSA PRIVATE KEY";
    ...
    const o = Object.assign(
      {
        ...
        timestamp: _(
          ((i = this.options.timeOffset),
          new Date(
            Date.now() + 6e4 * (new Date().getTimezoneOffset() + 60 * (i || 0))
          ))
        ),
      },
      r
    ...
    const a = b(o),
      s = Object.keys(a)
        ...
        .map((e) => {
          let t = a[e];
          return (
            "[object String]" !== Array.prototype.toString.call(t) &&
              (t = JSON.stringify(t)),
            `${e}=${t}`
          );
        })
  ...
  async _exec(e, t = {}, r = {}) {
    ...
    if (d) {
      throw new Error(d.sub_msg || d.msg || "接口返回错误");
    }
    throw new Error("request fail");
  }
  _checkResponseSign(e, r) {
    if (!this.options.alipayPublicKey || "" === this.options.alipayPublicKey) {
      return console.warn("options.alipayPublicKey is empty"), !0;
    }
    if (!e) {
      return !1;
    }
    ...
    return (
      i.update(n, "utf8"), i.verify(this.options.alipayPublicKey, o, "base64")
    );
  }
  _getSignStr(e, t) {
    let r = e.trim();
  ...
  _notifyRSACheck(e, r, n) {
    const o = Object.keys(e)
      ...
      .map((t) => {
        let r = e[t];
        return (
          "[object String]" !== Array.prototype.toString.call(r) &&
            (r = JSON.stringify(r)),
    ...
    return t
      .createVerify(_r[n])
      .update(o, "utf8")
      .verify(this.options.alipayPublicKey, r, "base64");
  }
  _checkNotifySign(e) {
    const t = e.sign;
    if (!this.options.alipayPublicKey || !t) {
      return !1;
    }
    ...
    return (
      !!this._notifyRSACheck(n, t, r) ||
      (delete n.sign_type, this._notifyRSACheck(n, t, r))
    );
  }
  _verifyNotify(e) {
    if (!e.headers) {
    ...
    for (const r in e.headers) {
      "content-type" === r.toLowerCase() && (t = e.headers[r]);
    }
    if (
      !1 !== e.isBase64Encoded &&
      -1 === t.indexOf("application/x-www-form-urlencoded")
    ) {
      throw new Error("通知格式不正确");
    }
    const r = s.parse(e.body);
    if (this._checkNotifySign(r)) {
      return v(r);
    }
...
var kr = function (e = {}) {
    return (
      (e.clientType = e.clientType || __ctx__.PLATFORM),
      (e.appId = e.appid),
      (e.secret = e.appsecret),
      k(br, e)
    );
  },
  xr = function (e = {}) {
...
function jr({ platform: e }) {
  const t = I(),
    r = e || __ctx__.PLATFORM;
  if (!t.oauth || !t.oauth.weixin) {
    throw new Error(
      `请在公用模块uni-id的config.json或init方法中添加${r}平台微信登录配置项`
    );
  }
  ["appid", "appsecret"].forEach((e) => {
    if (!t.oauth.weixin[e]) {
      throw new Error(
        `请在公用模块uni-id的config.json或init方法中添加配置项：${r}.oauth.weixin.${e}`
      );
    }
  });
...
function Cr({ platform: e }) {
  const t = I(),
    r = e || __ctx__.PLATFORM;
  if (!t.oauth || !t.oauth.alipay) {
    throw new Error(
      `请在公用模块uni-id的config.json或init方法中添加${r}平台支付宝登录配置项`
    );
  }
  ["appid", "privateKey"].forEach((e) => {
    if (!t.oauth.alipay[e]) {
      throw new Error(
        `请在公用模块uni-id的config.json或init方法中添加配置项：${r}.oauth.alipay.${e}`
      );
    }
  });
...
async function $r({ mobile: e, email: t, code: r, expiresIn: n, type: o }) {
  if ((!e && !t) || (e && t)) {
    return {
      code: 50101,
  ...
  try {
    ...
    return { code: 90001, msg: "记录验证信息失败" };
  }
}
async function Nr({ mobile: e, email: t, code: r, type: n }) {
  if ((!e && !t) || (e && t)) {
    return {
      code: 50201,
      msg: "手机号和邮箱必须且只能给定其中一个",
  ...
  try {
    ...
    if ((S("verifyRecord:", e), e && e.data && e.data.length > 0)) {
      const t = e.data[0];
      return (
        S("upRes", await T.doc(t._id).update({ state: 1 })),
        {
          code: 0,
          msg: "验证通过",
        }
    ...
    return { code: 90001, msg: "验证码校验失败" };
  }
}
const Br = uniCloud.database();
const Dr = uniCloud.database();
const Mr = uniCloud.database().command;
var Vr = {
  init: function (e) {
    O = e;
  },
  register: async function (e) {
    ...
    if (
      ...
      return { code: 20101, msg: "用户名、邮箱、手机号不可同时为空" };
    }
    const { username: n, email: o, mobile: i, myInviteCode: a } = e,
      s = hr.command;
    try {
      ...
      if ((S("userInDB:", c), c && c.data.length > 0)) {
        ...
        for (let n = 0; n < r.length; n++) {
          ...
          if (
            (o.extraCond &&
              (i = Object.keys(o.extraCond).every(
                (e) => t[e] === o.extraCond[e]
              )),
            t[o.name] === e[o.name] && i)
          ) {
      ...
      (e.password = R(e.password)),
        (e.register_date = new Date().getTime()),
        (e.register_ip = __ctx__.CLIENTIP),
      ...
      S("addRes", f);
      const d = f.id,
        { token: p, tokenExpired: l } = dr.createToken({ _id: d });
      return (
        await j.doc(d).update({ token: [p] }),
        {
          code: 0,
          uid: d,
          username: n,
      ...
      return { code: 90001, msg: "数据库写入异常" };
    }
  },
  login: async function ({ username: e, password: t, queryField: r = [] }) {
    const n = yr.command,
      o = [];
    (r && r.length) || (r = ["username"]);
    const i = {
      email: { email_confirmed: 1 },
      mobile: { mobile_confirmed: 1 },
    };
    r.forEach((t) => {
      o.push({ [t]: e, ...i[t] });
    });
    const a = await j
        ...
        .get(),
      s = __ctx__.CLIENTIP,
      { passwordErrorLimit: c, passwordErrorRetryTime: u } = I();
    if ((S("userInDB:", a), !(a && a.data && a.data.length > 0))) {
      return {
        code: 10101,
        msg: "用户不存在",
      };
    }
    {
      ...
      if (R(t) !== n) {
        return (
          i
            ? (i.error_times++, (i.last_error_time = Date.now()))
            : ((i = { ip: s, error_times: 1, last_error_time: Date.now() }),
              o.push(i)),
          await j.doc(r._id).update({ login_ip_limit: o }),
          {
            code: 10102,
            msg: "密码错误",
          }
      ...
      try {
        ...
        S("开始修改最后登录时间");
        const { token: i, tokenExpired: a } = dr.createToken(r);
        S("token", i), n.push(i);
        return (
          S(
            "upRes",
            await j.doc(r._id).update({
        ...
        return S("写入异常：", e), { code: 90001, msg: "数据库写入异常" };
      }
    }
  },
  loginByWeixin: async function (e) {
    ...
    const r = t.platform || __ctx__.PLATFORM,
      { openid: n, unionid: o } = await jr({ platform: r })[
        "mp-weixin" === r ? "code2Session" : "getOauthAccessToken"
      ](t.code);
    if (!n) {
      return { code: 10401, msg: "获取openid失败" };
    }
    const i = Tr.command,
      a = [{ wx_openid: { [r]: n } }];
    ...
    if (s && s.data && s.data.length > 0) {
      ...
      try {
        ...
        const { token: s, tokenExpired: c } = dr.createToken(e);
        S("token", s), a.push(s);
        const u = {
          last_login_date: new Date().getTime(),
        ...
        o && (u.wx_unionid = o);
        return (
          S("upRes", await j.doc(e._id).update(u)),
          {
            code: 0,
            msg: "登录成功",
            token: s,
      ...
      try {
        const e = {
          ...
          i = t.myInviteCode;
        i && (e.my_invite_code = i);
        const a = await mr(e);
        if (a.code > 0) {
          return a;
        }
        const s = a.result.id,
          { token: c, tokenExpired: u } = dr.createToken({ _id: s });
        return (
          await j.doc(s).update({ token: [c] }),
          {
            code: 0,
            msg: "登录成功",
            token: c,
  ...
  bindWeixin: async function ({ uid: e, code: t, platform: r }) {
    const n = r || __ctx__.PLATFORM,
      { openid: o, unionid: i } = await jr({ platform: n })[
        "mp-weixin" === n ? "code2Session" : "getOauthAccessToken"
      ](t);
    if (!o) {
      return { code: 60301, msg: "获取openid失败" };
    }
    const a = Or.command,
      s = [{ wx_openid: { [n]: o } }];
    i && s.push({ wx_unionid: i });
    ...
    try {
      const t = { wx_openid: { [n]: o } };
      return (
        i && (t.wx_unionid = i),
        await j.doc(e).update(t),
        {
          code: 0,
          msg: "绑定成功",
        }
  ...
  unbindWeixin: async function (e) {
    try {
      const t = Ir.command,
        r = await j
          .doc(e)
          .update({ wx_openid: t.remove(), wx_unionid: t.remove() });
      return (
        S("upRes:", r),
        1 === r.updated
          ? { code: 0, msg: "微信解绑成功" }
          : { code: 70301, msg: "微信解绑失败，请稍后再试" }
      );
    } catch (e) {
      return S("写入异常：", e), { code: 90001, msg: "数据库写入异常" };
    }
  ...
  loginByAlipay: async function (e) {
    ...
    "string" == typeof e && (t = { code: e });
    const r = t.platform || __ctx__.PLATFORM,
      { openid: n } = await Cr({ platform: r }).code2Session(t.code);
    if (!n) {
      return { code: 10501, msg: "获取openid失败" };
    }
    const o = await j.where({ ali_openid: n }).get();
    if (o && o.data && o.data.length > 0) {
      ...
      try {
        ...
        const { token: i, tokenExpired: a } = dr.createToken(e);
        S("token", i), o.push(i);
        return (
          S(
            "upRes",
            await j.doc(e._id).update({
              last_login_date: new Date().getTime(),
              last_login_ip: __ctx__.CLIENTIP,
              token: o,
            })
      ...
      try {
        ...
        const i = o.result,
          a = i.id,
          { token: s, tokenExpired: c } = dr.createToken({ _id: a });
        return (
          await j.doc(a).update({ token: [s] }),
          {
            code: 0,
            msg: "登录成功",
            token: s,
  ...
  bindAlipay: async function ({ uid: e, code: t, platform: r }) {
    const n = r || __ctx__.PLATFORM,
      { openid: o } = await Cr({ platform: n }).code2Session(t);
    if (!o) {
      return { code: 60401, msg: "获取openid失败" };
    }
    const i = await j.where({ ali_openid: o }).get();
    ...
    try {
      return (
        await j.doc(e).update({ ali_openid: o }),
        {
          code: 0,
          msg: "绑定成功",
        }
  ...
  unbindAlipay: async function (e) {
    try {
      const t = Rr.command,
        r = await j.doc(e).update({ ali_openid: t.remove() });
      return (
        S("upRes:", r),
        1 === r.updated
          ? { code: 0, msg: "支付宝解绑成功" }
          : { code: 70401, msg: "支付宝解绑失败，请稍后再试" }
      );
    } catch (e) {
      return S("写入异常：", e), { code: 90001, msg: "数据库写入异常" };
    }
  ...
  logout: async function (e) {
    ...
    try {
      const r = Ar.command;
      return (
        await j.doc(t.uid).update({ token: r.pull(e) }),
        {
          code: 0,
          msg: "退出成功",
        }
      ...
      try {
        return (
          S(
            ...
            await j
              .doc(t.data[0]._id)
              .update({ password: R(e.newPassword), token: [] })
          ),
          {
            code: 0,
            msg: "修改成功",
        ...
        return S("发生异常", e), { code: 90001, msg: "数据库写入异常" };
      }
    }
  },
  updateUser: async function (e) {
    const t = e.uid;
    if (!t) {
      return { code: 80101, msg: "缺少uid参数" };
    }
    delete e.uid;
    try {
      return (
        S("update -> upRes", await j.doc(t).update(e)),
        {
          code: 0,
          msg: "修改成功",
        }
  ...
  setAvatar: async function (e) {
    try {
      return (
        S(
          "setAvatar -> upRes",
          await j.doc(e.uid).update({ avatar: e.avatar })
        ),
        { code: 0, msg: "头像设置成功" }
      );
    } catch (e) {
  ...
  bindMobile: async function ({ uid: e, mobile: t, code: r }) {
    try {
      const n = await j.where({ mobile: t, mobile_confirmed: 1 }).count();
      if (n && n.total > 0) {
        return { code: 60101, msg: "此手机号已被绑定" };
      }
      if (r) {
        const e = await Nr({ mobile: t, code: r, type: "bind" });
        if (0 !== e.code) {
          return e;
        }
      }
      return (
        S(
          "bindMobile -> upRes",
          await j.doc(e).update({ mobile: t, mobile_confirmed: 1 })
        ),
        { code: 0, msg: "手机号码绑定成功" }
      );
    } catch (e) {
  ...
  bindEmail: async function ({ uid: e, email: t, code: r }) {
    try {
      const n = await j.where({ email: t, email_confirmed: 1 }).count();
      if (n && n.total > 0) {
        return { code: 60201, msg: "此邮箱已被绑定" };
      }
      if (r) {
        const e = await Nr({ email: t, code: r, type: "bind" });
        if (0 !== e.code) {
          return e;
        }
      }
      return (
        S(
          "bindEmail -> upRes",
          await j.doc(e).update({ email: t, email_confirmed: 1 })
        ),
        { code: 0, msg: "邮箱绑定成功" }
      );
    } catch (e) {
  ...
  resetPwd: async function ({ uid: e, password: t }) {
    try {
      return (
        S("upRes", await j.doc(e).update({ password: R(t), token: [] })),
        { code: 0, msg: "密码重置成功" }
      );
    } catch (e) {
      return S("发生异常", e), { code: 90001, msg: "数据库写入异常" };
  ...
  unbindMobile: async function ({ uid: e, mobile: t, code: r }) {
    try {
      if (r) {
        const e = await Nr({ mobile: t, code: r, type: "unbind" });
        if (0 !== e.code) {
          return e;
        }
      }
      ...
      return 1 ===
        (
          await j
            .where({ _id: e, mobile: t })
            .update({ mobile: n.remove(), mobile_confirmed: n.remove() })
        ).updated
        ? { code: 0, msg: "手机号解绑成功" }
  ...
  setVerifyCode: $r,
  verifyCode: Nr,
  sendSmsCode: async function ({ mobile: e, code: t, type: r }) {
    if (!e) {
    ...
    if (!o) {
      throw new Error(
        "请在config.json或init方法中配置service.sms下短信相关参数"
      );
    }
    ...
    for (let e = 0, t = i.length; e < t; e++) {
      const t = i[e];
      if (!o[t]) {
        throw new Error("请在config.json或init方法中service.sms下配置" + t);
      }
    }
    const { name: a, smsKey: s, smsSecret: c, codeExpiresIn: u } = o;
    let f;
    switch (r) {
      case "login":
        f = "登录";
    ...
    try {
      ...
      const n = await $r({ mobile: e, code: t, expiresIn: u, type: r });
      return n.code >= 0 ? n : { code: 0, msg: "验证码发送成功" };
    } catch (e) {
  ...
  loginBySms: async function ({
    ...
    const a = I();
    if (a.forceInviteCode && !i) {
      throw new Error(
        "[loginBySms]强制使用邀请码注册时，需指明type为register还是login"
      );
    }
    const s = await Nr({ mobile: e, code: t, type: i || "login" });
    if (0 !== s.code) {
      return s;
    }
    const c = { mobile: e, mobile_confirmed: 1 },
      u = await j.where(c).get();
    if ((S("userInDB:", u), !(u && u.data && u.data.length > 0))) {
      const t = Date.now();
      if ("login" === i) {
        return { code: 10203, msg: "此手机号尚未注册" };
      }
      const s = {
        mobile: e,
        mobile_confirmed: 1,
      ...
      if ("register" === i) {
        if ((r && (s.password = R(r)), n)) {
          const e = await j.where({ my_invite_code: n }).get();
          if (1 !== e.data.length) {
            return { code: 10202, msg: "邀请码无效" };
          }
          (s.inviter_uid = [e.data[0]._id].concat(e.data[0].inviter_uid || [])),
            (s.invite_time = t);
        } else if (a.forceInviteCode) {
          return { code: 10202, msg: "邀请码无效" };
        }
      ...
      const f = u.id;
      if (u.id) {
        const { token: t, tokenExpired: r } = dr.createToken({ _id: f });
        return (
          await j.doc(f).update({ token: [t] }),
          {
            code: 0,
            uid: f,
            mobile: e,
      ...
      return { code: 90001, msg: "数据库写入失败" };
    }
    {
      if ("register" === i) {
        return { code: 10201, msg: "此手机号已注册" };
      }
      const t = u.data[0];
      try {
        const r = await gr(t);
        ...
        S("开始修改最后登录时间");
        const { token: o, tokenExpired: i } = dr.createToken(t);
        S("token", o), n.push(o);
        return (
          S(
            "upRes",
            await j.doc(t._id).update({
              last_login_date: new Date().getTime(),
              last_login_ip: __ctx__.CLIENTIP,
              token: n,
            })
  ...
  loginByEmail: async function ({
    ...
    const i = await Nr({ email: e, code: t, type: o || "login" });
    if (0 !== i.code) {
      return i;
    }
    const a = { email: e, email_confirmed: 1 },
    ...
    if ((S("userInDB:", s), !(s && s.data && s.data.length > 0))) {
      ...
      "register" === o &&
        (r && (t.password = R(r)), n && (t.my_invite_code = n));
      const i = await mr(t);
      if (i.code > 0) {
        return i;
      }
      ...
      const s = a.id;
      if (a.id) {
        const { token: t, tokenExpired: r } = dr.createToken({ _id: s });
        return (
          await j.doc(s).update({ token: [t] }),
          {
            code: 0,
            msg: "注册成功",
            uid: s,
  ...
  unbindEmail: async function ({ uid: e, email: t, code: r }) {
    try {
      if (r) {
        const e = await Nr({ email: t, code: r, type: "unbind" });
        if (0 !== e.code) {
          return e;
        }
      }
      ...
      return 1 ===
        (
          await j
            .where({ _id: e, email: t })
            .update({ email: n.remove(), email_confirmed: n.remove() })
        ).updated
        ? { code: 0, msg: "邮箱解绑成功" }
  ...
  setUserInviteCode: async function ({ uid: e, myInviteCode: t }) {
    const r = await lr({ inviteCode: t });
    if (r.code > 0) {
      return r;
    }
    try {
      return (
        await j.doc(e).update({ my_invite_code: r.inviteCode }),
        {
          code: 0,
          msg: "邀请码设置成功",
  ...
  acceptInvite: async function ({ uid: e, inviteCode: t }) {
    const r = await j
      .where({
        _id: Mr.neq(e),
        inviter_uid: Mr.not(Mr.all([e])),
        my_invite_code: t,
      })
      .get();
    if (1 !== r.data.length) {
      return { code: 80501, msg: "邀请码无效" };
    }
    const n = [r.data[0]._id].concat(r.data[0].inviter_uid || []),
      o = await j.doc(e).field({ my_invite_code: !0, inviter_uid: !0 }).get();
    if (0 === o.data.length) {
      return { code: 80502, msg: "uid错误用户不存在" };
    }
    if (o.data[0].inviter_uid && o.data[0].inviter_uid.length > 0) {
      return {
        code: 80503,
        msg: "邀请码不可修改",
      };
    ...
    try {
      const t = Date.now();
      return (
        await j.doc(e).update({ inviter_uid: n, invite_time: t }),
        await j.where({ inviter_uid: e }).update({ inviter_uid: Mr.push(n) }),
        { code: 0, msg: "邀请码填写成功" }
      );
    } catch (e) {
      return { code: 90001, msg: "数据库写入异常" };
  ...
  getInvitedUser: async function ({
    ...
    try {
      ...
      if (o) {
        const r = await j.where({ ["inviter_uid." + (t - 1)]: e }).count();
        i.total = r.total;
      }
      return i;
    } catch (e) {
